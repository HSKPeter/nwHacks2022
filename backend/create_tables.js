...
function insert_found_items(name, date, lat, lon, transport, image_url, contact) {
    if (lat == null) {
    ...
    let sql = `INSERT INTO found_items VALUES (null, '${name}','${date}',${lat},${lon},${transport}, '${image_url}', '${contact}')`;
...
module.exports = {insert_found_items, get_list_found_items, reset_tables, get_list_all_hashtag, get_list_lost_items, insert_lost_items,add_hashtag, formatting_date, create_tables};
